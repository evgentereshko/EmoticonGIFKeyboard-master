...
import com.kevalpatel2106.emoticongifkeyboard.internal.stickercon.StickerconFragment;
...
public final class EmoticonGIFKeyboardFragment extends Fragment implements FragmentManager.OnBackStackChangedListener {
    ...
    public static final String TAG_STICKERS_FRAGMENT = "tag_stickers_fragment";
    ...
    @NonNull
    private final StickerconFragment mStickersFragment;
    ...
    private boolean mIsStrickersEnable;
     ...
     * {@link #getNewInstance(View, EmoticonConfig, GIFConfig,StickerConfig)} instead.
     *
     * @see #getNewInstance(View, EmoticonConfig, GIFConfig,StickerConfig)
     */
    ...
    public EmoticonGIFKeyboardFragment() {
        ...
        mStickersFragment = new StickerconFragment();
    }
    ...
    public static EmoticonGIFKeyboardFragment getNewInstance(@NonNull View container,
                                                             ...
                                                             @Nullable GIFConfig gifConfig,@Nullable StickerConfig stickerConfig) {
        //Validate inputs
        if (emoticonConfig == null && gifConfig == null && stickerConfig == null)
            throw new IllegalStateException("At least one of emoticon or GIF or stickers should be active.");
        ...
        if (stickerConfig != null) {
            emoticonGIFKeyboardFragment.mIsStrickersEnable = true;
            emoticonGIFKeyboardFragment.setStickersProvider(stickerConfig.mStickerProvider);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final View searchBtn = view.findViewById(R.id.search_btn);
        //Set emoticon button
        ...
        //Set Stickers button
        mStickerBtn = view.findViewById(R.id.btn_stickers_tab);
        mStickerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view14) {
                searchBtn.setVisibility(View.GONE);
                EmoticonGIFKeyboardFragment.this.replaceFragment(mStickersFragment, TAG_STICKERS_FRAGMENT);
            }
        });
        mStickerBtn.setVisibility(isEmoticonsEnable() && isGIFsEnable() && isStickersEnable() ? View.VISIBLE : View.GONE); // && isStickersEnable()
...
//        searchBtn = view.findViewById(R.id.search_btn);
        ...
        if (savedInstanceState != null) {   //Fragment reloaded from config changes,
            ...
            if (isEmoticonsEnable())
               ...
               replaceFragment(mStickersFragment, TAG_STICKERS_FRAGMENT);
            else
    ...
    public void setStickersProvider(@Nullable String stickersProvider) {
        mStickersFragment.setStickersProvider(stickersProvider);
    }
    ...
    public void setStickerSelectListener(@Nullable StickerconSelectListener stickerSelectListener) {
        mStickersFragment.setStickerSelectListener(stickerSelectListener);
    }
    ...
    @StringDef({TAG_EMOTICON_FRAGMENT, TAG_EMOTICON_SEARCH_FRAGMENT, TAG_GIF_FRAGMENT, TAG_GIF_SEARCH_FRAGMENT,TAG_STICKERS_FRAGMENT})
    ...
    public final static class StickerConfig {
        ...
        @Nullable
        private StickerconSelectListener mStickerSelectListener;

        @NonNull
        private String mStickerProvider;

        public StickerConfig(@NonNull String stickerconProvider) {
            this.mStickerProvider = stickerconProvider;
        }

        @NonNull
        public StickerConfig setStickerSelectListener(@Nullable StickerconSelectListener stickerSelectListener) {
